...
export default class Fetch1 extends Component {
  ...
  componentWillMount() {
    fetch("https://api.themoviedb.org/3/movie/now_playing?api_key=da46474f8dd8ea1caebd07b84cb98b86&language=en-US&page=2").then(res => {
      return res.json();
    }).then((dt1) => {
      this.setState({
        data: dt1
